...
def test_score_situation_higher_for_high_priority():
    ...
    items_high = [
        {"source": "jira", "priority": "high", "hierarchy": "project", "timestamp": base_ts},
        {"source": "slack", "priority": "high", "hierarchy": "project", "timestamp": base_ts},
    ]
    items_low = [
        {"source": "jira", "priority": "low", "hierarchy": "project", "timestamp": base_ts},
...
def test_score_situation_recency_decay():
    ...
    items_recent = [
        {"source": "jira", "priority": "medium", "hierarchy": "project", "timestamp": recent},
        {"source": "slack", "priority": "medium", "hierarchy": "project", "timestamp": recent},
    ]
    items_old = [
        {"source": "jira", "priority": "medium", "hierarchy": "project", "timestamp": old},
